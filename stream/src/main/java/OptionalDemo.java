...
public class OptionalDemo {
    public static void main(String[] args) {
        ...
        //System.out.println(numbers.isPresent()); //error bcs isPresent() belongs to Optional class numbers is a List
        System.out.println(Optional.of(numbers).isPresent());

        //ifPresent
        Optional<Integer> bigNumber = numbers.stream().filter(x -> x>100).findAny();
        bigNumber.ifPresent(System.out::println);  //does do not throw exception
